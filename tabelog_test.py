...
if __name__ == '__main__':
    ...
    if len(count_list)>11:
        print('tabelog爬虫正常,测试元数据量981,实际得到数据量%s'%(len(count_list)))
    else:
        print('异常!!!!!,测试元数据量981,实际得到数据量%s' % (len(count_list)))
